(function(t) {
    ...
    ;
    var Me = (e, t, r) => (r = e != null ? yu(wu(e)) : {},
    sr(t || !e || !e.__esModule ? He(r, "default", {
        value: e,
        enumerable: !0
    }) : r, e))
      , ar = e => sr(He({}, "__esModule", {
        value: !0
    }), e);
    var vu = (e, t, r) => t.has(e) || or("Cannot " + r);
    var Dr = (e, t, r) => t.has(e) ? or("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r);
    var pe = (e, t, r) => (vu(e, t, "access private method"),
    r);
    var ot = At( (oa, sn) => {
        "use strict";
        var on = new Proxy(String,{
            get: () => on
        });
        sn.exports = on
    }
    ...
    var $n = At(Ct => {
        ...
        var xi = Hn.default, Rn = (e, t) => r => e(t(r)), Zt;
        function vi(e) {
            if (e) {
                var t;
                return (t = Zt) != null || (Zt = (0,
                Hn.createColors)(!0)),
                Zt
            }
            return xi
        ...
        function Mn(e, t, r={}) {
            ...
            In.shouldHighlight)(r)
              ...
              , f = String(D).length
              , c = (n ? (0,
            In.default)(e, r) : e).split(jn, D).slice(a, D).map( (F, m) => {
                let E = a + 1 + m
                  , w = ` ${` ${E}`.slice(-f)} |`
                  , h = l[E]
                  , C = !l[E + 1];
...
${c}`),
    ...
    Z.prototype = {
        diff: function(t, r) {
            ...
            function A() {
                for (var h = Math.max(m, -l); h <= Math.min(E, l); h += 2) {
                    ...
                    if (!yt || $ && k.oldPos + 1 < v.oldPos ? C = o.addToPath(v, !0, void 0, 0) : C = o.addToPath(k, void 0, !0, 1),
        ...
        extractCommon: function(t, r, n, i) {
            for (var u = r.length, o = n.length, s = t.oldPos, a = s - i, D = 0; a + 1 < u && s + 1 < o && this.equals(r[a + 1], n[s + 1]); )
                a++,
                s++,
                D++;
            return D && (t.lastComponent = {
                count: D,
    ...
    function Ou(e, t, r, n, i) {
        ...
        for (var s = 0, a = u.length, D = 0, l = 0; s < a; s++) {
            var d = u[s];
            if (d.removed) {
                if (d.value = e.join(n.slice(l, l + d.count)),
                l += d.count,
                s && u[s - 1].added) {
                    var p = u[s - 1];
                    u[s - 1] = u[s],
        ...
        var c = u[a - 1];
        return a > 1 && typeof c.value == "string" && (c.added || c.removed) && e.equals("", c.value) && (u[a - 2].value += c.value,
        u.pop()),
        u
    }
    var ho = new Z;
    ...
    fr.tokenize = function(e) {
        for (var t = e.split(/([^\S\r\n]+|[()[\]{}'"\r\n]|\b)/), r = 0; r < t.length - 1; r++)
            !t[r + 1] && t[r + 2] && lr.test(t[r]) && lr.test(t[r + 2]) && (t[r] += t[r + 2],
            t.splice(r + 1, 2),
            r--);
        return t
    }
...
`));
        ...
        for (var n = 0; n < r.length; n++) {
            var i = r[n];
            n % 2 && !this.options.newlineIsToken ? t[t.length - 1] += i : (this.options.ignoreWhitespace && (i = i.trim()),
            t.push(i))
        }
        return t
    }
    ...
    Ae.castInput = function(e) {
        var t = this.options
          ...
          , i = n === void 0 ? function(u, o) {
            return typeof o > "u" ? r : o
        }
        : n;
        return typeof e == "string" ? e : JSON.stringify(Bt(e, null, null, i), i, "  ")
    }
    ;
...
`)
    ...
    var G = ku;
    var Lu = e => new Intl.ListFormat("en-US",{
        type: "disjunction"
    }).format(e);
    function Pu(e) {
...
Expected it to be ${n}.`
    ...
    function Je(e, t, r) {
        ...
        if (t > 0) {
            for (let i = 0; i < Math.floor(t / r); ++i)
                n = De(n);
            n = ae(t % r, n),
            n = ae(Number.NEGATIVE_INFINITY, n)
        }
        return n
    }
    function br(e, t) {
    ...
    function Or(e) {
        ...
        function n(u, o, s) {
            ...
            if (u.type === b)
                return ((D = s == null ? void 0 : s[o - 1]) == null ? void 0 : D.type) === B && s[o - 1].hard ? void 0 : "breakParent";
            if (u.type === I)
                return "trim";
            if (u.type === L)
            ...
            if (u.type === x)
                return "ifBreak(" + n(u.breakContents) + (u.flatContents ? ", " + n(u.flatContents) : "") + (u.groupId ? (u.flatContents ? "" : ', ""') + `, { groupId: ${i(u.groupId)} }` : "") + ")";
            if (u.type === R) {
                let l = [];
        ...
        function i(u) {
            ...
            for (let s = 0; ; s++) {
                ...
                if (!r.has(a))
                    return r.add(a),
                    t[u] = `Symbol.for(${JSON.stringify(a)})`
            }
        }
    }
    var Ru = (e, t, r) => {
    ...
    function Pr(e) {
        for (e = [...e]; e.length >= 2 && y(!1, e, -2).type === B && y(!1, e, -1).type === b; )
            e.length -= 2;
        if (e.length > 0) {
            let t = Se(y(!1, e, -1));
            e[e.length - 1] = t
        ...
        case W:
            {
                ...
                for (let r of e) {
                    ...
                    typeof n == "string" && typeof y(!1, t, -1) == "string" ? t[t.length - 1] += n : t.push(n),
                    t.push(...i)
                }
...
`)) : r)
    ...
    function zu(e, t, r) {
        return t === Number.NEGATIVE_INFINITY ? e.root || Wr() : t < 0 ? bt(e, {
            type: "dedent"
        }, r) : t ? t.type === "root" ? {
            ...e,
            root: e
            ...
            case _:
                {
                    if (u && l.break)
                        return !1;
                    let f = l.break ? H : D
                      , p = l.expandedStates && f === H ? y(!1, l.expandedStates, -1) : l.contents;
                    s.push({
                        mode: f,
                        doc: p
                    });
...
`, i) : c;
            ...
            case S:
                {
                    ...
                    et({
                        ...
                        mode: J,
                        doc: [E, A, ye]
                    }, [], F, D.length > 0, r, !0) ? o.push($, k, w) : C ? o.push($, v, w) : o.push($, v, h);
                    break
                }
            case x:
            case R:
            ...
            case B:
                ...
                case H:
                    ...
                    c.literal ? f.root ? (s.push(i, f.root.value),
                    u = f.root.length) : (s.push(i),
                    u = 0) : (u -= Ot(s),
                    s.push(i + f.value),
                    u = f.length);
                    break
            ...
            o.length === 0 && D.length > 0 && (o.push(...D.reverse()),
            D.length = 0)
        }
        let d = s.indexOf(Te);
        if (d !== -1) {
...
` || i === "\r" || i === "\u2028" || i === "\u2029")
    ...
    var kt = Xu;
    var Gr = new Set(["tokens", "comments", "parent", "enclosingNode", "precedingNode", "followingNode"])
    ...
    function ei(e) {
        ...
        return r.length > 20 && (r = r.slice(0, 19) + "\u2026"),
        t + (r ? " " + r : "")
    }
    function Lt(e, t) {
    ...
    function ut(e, t) {
        ...
        if (!n)
            return [];
        let s = ((r == null ? void 0 : r(e, t)) ?? [...Tt(e, {
            getVisitorKeys: X(i)
        })]).flatMap(a => n(a) ? [a] : ut(a, t));
        return s.sort( (a, D) => u(a) - u(D) || o(a) - o(D)),
        Pt.set(e, s),
        s
    }
    function qr(e, t, r, n) {
        let {locStart: i, locEnd: u} = r, o = i(t), s = u(t), a = ut(e, r), D, l, d = 0, f = a.length;
        for (; d < f; ) {
            let p = d + f >> 1
              , c = a[p]
              , F = i(c)
    ...
    function Jr(e, t) {
        ...
        !kt(r) || !t.printer.canAttachComment)
            return;
        let n = []
          , {locStart: i, locEnd: u, printer: {experimentalFeatures: {avoidAstMutation: o=!1}={}, handleComments: s={}}, originalText: a} = t
        ...
        for (let[p,c] of f.entries()) {
            ...
            else if (F.placement = "remaining",
            !d(...v))
                if (m && A) {
                    let $ = n.length;
                    $ > 0 && n[$ - 1].followingNode !== A && Kr(n, h),
                    n.push(c)
                } else
                    m ? ie(m, F) : A ? ue(A, F) : E ? re(E, F) : re(C, F)
        }
        if (Kr(n, t),
        !o)
            for (let p of r)
...
in order for it to be formatted.`,
    ...
    function it({plugins: e=[], showDeprecated: t=!1}={}) {
        ...
        for (let i of Di(Object.assign({}, ...e.map( ({options: u}) => u), rn)))
            !t && i.deprecated || (Array.isArray(i.choices) && (t || (i.choices = i.choices.filter(u => !u.deprecated)),
            i.name === "parser" && (i.choices = [...i.choices, ...ai(i.choices, r, e)])),
            i.pluginDefaults = Object.fromEntries(e.filter(u => {
                var o;
    ...
    function fi(e, t) {
        let r = e.plugins.flatMap(i => i.languages ?? [])
          , n = ci(r, t.language) ?? nn(r, t.physicalFile) ?? nn(r, t.file) ?? (t.physicalFile,
        void 0);
    ...
    var Yt = Me(ot(), 1)
      , an = (e, t, {descriptor: r}) => {
        ...
        return t && n.push(`we now treat it as ${Yt.default.blue(typeof t == "string" ? r.key(t) : r.pair(t))}`),
        n.join("; ") + "."
    }
    ;
    var le = Me(ot(), 1);
    ...
    var Dn = " ".repeat(2)
      , cn = (e, t, r) => {
        let {text: n, list: i} = r.normalizeExpectedResult(r.schemas[e].expected(r))
          , u = [];
        return n && u.push(ln(e, t, n, r.descriptor)),
        i && u.push([ln(e, t, i.title, r.descriptor)].concat(i.values.map(o => fn(o, r.loggerPrintWidth))).join(`
`)),
    ...
    function fn({text: e, list: t}, r) {
        let n = [];
        return e && n.push(`- ${le.default.blue(e)}`),
        t && n.push([`- ${le.default.blue(t.title)}:`].concat(t.values.map(i => fn(i, r - Dn.length).replace(/^|\n/g, `$&${Dn}`))).join(`
`)),
        pn(n, r)
    }
    function pn(e, t) {
...
`, 1)[0].length);
    ...
    function Ht(e, t) {
        ...
        let n = e.length
          , i = t.length;
        for (; n > 0 && e.charCodeAt(~-n) === t.charCodeAt(~-i); )
            n--,
            i--;
        let u = 0;
        ...
        let o, s, a, D, l = 0, d = 0;
        for (; l < n; )
            dn[l] = e.charCodeAt(u + l),
            jt[l] = ++l;
        for (; d < i; )
            for (o = t.charCodeAt(u + d),
            a = d++,
            s = d,
            l = 0; l < n; l++)
                D = o === dn[l] ? a : a + 1,
    ...
    var at = (e, t, {descriptor: r, logger: n, schemas: i}) => {
        let u = [`Ignored unknown option ${Wt.default.yellow(r.pair({
            key: e,
            value: t
        }))}.`]
          , o = Object.keys(i).sort().find(s => Ht(e, s) < 3);
    ...
    function di(e, t) {
        let r = new e(t)
          , n = Object.create(r);
        for (let i of pi)
            i in t && (n[i] = Fi(t[i], r, O.prototype[i].length));
        return n
    }
    var O = class {
        static create(t) {
    ...
    var ct = class extends O {
        ...
        redirect(t, r) {
            ...
            for (let u of t) {
                ...
                "remain"in o && n.push(o.remain),
                i.push(...o.redirect.map(Fn))
            }
            return n.length === 0 ? {
                redirect: i
            } : {
    ...
    function En(e, t) {
        ...
        for (let n of e) {
            let i = n[t];
            if (r[i])
                throw new Error(`Duplicate ${t} ${JSON.stringify(i)}`);
            r[i] = n
        }
        return r
    }
    ...
    function $t(e) {
        ...
        let {text: t, list: r} = e;
        return mi((t || r) !== void 0, "Unexpected `expected` result, there should be at least one field."),
        r ? {
            text: t,
            list: {
                title: r.title,
    ...
    var dt = class extends O {
        constructor(t) {
            super(t),
            this._choices = hn(t.choices.map(r => r && typeof r == "object" ? r : {
                value: r
            }), "value")
        }
        expected({descriptor: t}) {
            let r = Array.from(this._choices.keys()).map(o => this._choices.get(o)).filter( ({hidden: o}) => !o).map(o => o.value).sort(An).map(t.value)
              , n = r.slice(0, -2)
              , i = r.slice(-2);
            return {
    ...
    var Et = class {
        constructor(t, r) {
            let {logger: n=console, loggerPrintWidth: i=80, descriptor: u=wn, unknown: o=_n, invalid: s=xn, deprecated: a=vn, missing: D= () => !1, required: l= () => !1, preprocess: d=p => p, postprocess: f= () => he} = r || {};
            this._utils = {
                descriptor: u,
                logger: n || {
                    warn: () => {}
        ...
        normalize(t) {
            ...
            for (let o of Object.keys(this._utils.schemas)) {
                ...
                D !== he && (this._applyValidation(D, o, s),
                r[o] = D)
            }
            return this._applyPostprocess(r),
            this._applyRequiredCheck(r),
            r
        }
        ...
        _partitionOptionKeys(t) {
            let[r,n] = gn(Object.keys(t).filter(i => !this._identifyMissing(i, t)), i => i in this._utils.schemas);
            return {
                knownKeys: r,
                unknownKeys: n
            }
        ...
        _applyPostprocess(t) {
            ...
            if (r !== he) {
                ...
                if (r.override) {
                    ...
                    for (let u of n) {
                        let o = r.override[u];
                        this._applyValidation(o, u, this._utils.schemas[u]),
                        t[u] = o
                    }
                    for (let u of i) {
                        let o = r.override[u];
    ...
    ;
    var Gt;
    function hi(e, t, {logger: r=!1, isCLI: n=!1, passThrough: i=!1, FlagSchema: u, descriptor: o}={}) {
        if (n) {
            if (!u)
            ...
            o = oe;
        let s = i ? Array.isArray(i) ? (f, p) => i.includes(f) ? {
            [f]: p
        } : void 0 : (f, p) => ({
            [f]: p
        }) : (f, p, c) => {
        ...
        let d = D.normalize(e);
        return l && (Gt = D._hasDeprecationWarned),
        d
    }
    ...
    function gi(e, {isCLI: t, optionInfos: r, FlagSchema: n}) {
        ...
        case "choice":
            o = dt,
            u.choices = e.choices.map(a => a != null && a.redirect ? {
                ...a,
                redirect: {
                    to: {
                        key: e.name,
        ...
        case "flag":
            o = n,
            u.flags = r.flatMap(a => [a.alias, a.description && a.name, a.oppositeDescription && `no-${a.name}`].filter(Boolean));
            break;
        case "path":
            o = Re;
            break;
        ...
        if (e.exception ? u.validate = (a, D, l) => e.exception(a) || D.validate(a, l) : u.validate = (a, D, l) => a === void 0 || D.validate(a, l),
        e.redirect && (s.redirect = a => a ? {
        ...
        t && !e.array) {
            ...
            u.preprocess = (D, l, d) => l.preprocess(a(Array.isArray(D) ? y(!1, D, -1) : D), d)
        }
    ...
    function qt(e, t) {
        ...
        let r = Kt(!1, e, i => i.parsers && Object.prototype.hasOwnProperty.call(i.parsers, t));
        if (r)
            return r;
        let n = `Couldn't resolve parser "${t}".`;
        throw n += " Plugins must be explicitly added to the standalone bundle.",
        new Pe(n)
    }
    function On(e, t) {
        if (!t)
            throw new Error("astFormat is required.");
        let r = Kt(!1, e, i => i.printers && Object.prototype.hasOwnProperty.call(i.printers, t));
        if (r)
            return r;
    ...
    async function Ai(e, t={}) {
        ...
        let s = (d = u.printers) != null && d[o.astFormat] ? u : On(r.plugins, o.astFormat)
...
` + n,
    ...
    async function Un(e, t, r, n, i) {
        let {embeddedLanguageFormatting: u, printer: {embed: o, hasPrettierIgnore: s= () => !1, getVisitorKeys: a}} = r;
        if (!o || u !== "auto")
            return;
        if (o.length > 2)
    ...
    function Li(e, t) {
        let {originalText: r, [Symbol.for("comments")]: n, locStart: i, locEnd: u, [Symbol.for("printedComments")]: o} = t
          , {node: s} = e
          , a = i(s)
          , D = u(s);
        for (let l of n)
    ...
    function Gn(e, t, r, n, i) {
        ...
        return (a = o.hasPrettierIgnore) != null && a.call(o, e) ? s = zn(e, t) : i.has(u) ? s = i.get(u) : s = o.print(e, t, r, n),
        u === t.cursorNode && (s = Qe(s, D => [ve, D, ve])),
        o.printComment && (!o.willPrintOwnComments || !o.willPrintOwnComments(e, t)) && (s = Qr(e, s, t)),
        s
    }
    ...
    function Ii(e, t) {
        ...
        function o(s, a) {
            ...
            let D = {}
              , l = new Set(i(s));
            for (let f in s)
                !Object.prototype.hasOwnProperty.call(s, f) || u.has(f) || (l.has(f) ? D[f] = o(s[f], s) : D[f] = s[f]);
            let d = r(s, D, a);
            if (d !== null)
                return d ?? D
        }
    ...
    var Ri = (e, t, r) => {
      ...
      , Jn = Ri;
    var Yi = ({parser: e}) => e === "json" || e === "json5" || e === "jsonc" || e === "json-stringify";
    function ji(e, t) {
    ...
    var Qn = new Set(["JsonRoot", "ObjectExpression", "ArrayExpression", "StringLiteral", "NumericLiteral", "BooleanLiteral", "NullLiteral", "UnaryExpression", "TemplateLiteral"])
      , Mi = new Set(["OperationDefinition", "FragmentDefinition", "VariableDefinition", "TypeExtensionDefinition", "ObjectTypeDefinition", "FieldDefinition", "DirectiveDefinition", "EnumTypeDefinition", "EnumValueDefinition", "InputValueDefinition", "InputObjectTypeDefinition", "SchemaDefinition", "OperationTypeDefinition", "InterfaceTypeDefinition", "UnionTypeDefinition", "ScalarTypeDefinition"]);
    function Zn(e, t, r) {
        if (!t)
            return !1;
        switch (e.parser) {
    ...
    function eu(e, t, r) {
        ...
        if (Yi(t)) {
            ...
            ({startNode: d, endNode: f} = Hi(D, l, t));
        return {
    ...
    async function iu(e, t, r=0) {
        ...
        if (r > 0) {
            ...
            o.cursorNodeStart !== void 0 && (o.cursorNodeStart -= o.formatted.indexOf(a)),
            o.formatted = a + Be(t.endOfLine)
        }
        let s = t[Symbol.for("comments")];
        if (t.cursorOffset >= 0) {
            let a, D, l, d, f;
            if (t.cursorNode && o.cursorNodeText ? (a = t.locStart(t.cursorNode),
            D = i.slice(a, t.locEnd(t.cursorNode)),
            l = t.cursorOffset - a,
            d = o.cursorNodeStart,
            f = o.cursorNodeText) : (a = 0,
            D = i,
            l = t.cursorOffset,
            d = 0,
            f = o.formatted),
...
`, i) + 1)
          ...
          , {cursorOffset: f} = t;
        f > u ? f += d.length - o.length : l.cursorOffset >= 0 && (f = l.cursorOffset + i);
...
`, c)
    ...
    function ou(e, t) {
        let {cursorOffset: r, rangeStart: n, rangeEnd: i, endOfLine: u} = ru(e, t)
          , o = e.charAt(0) === uu;
        if (o && (e = e.slice(1),
        r--,
        n--,
...
`);
    ...
    async function rr(e, t) {
        ...
        if (i.rangeStart >= i.rangeEnd && n !== "" || i.requirePragma && !await nu(n, i))
            return {
                formatted: e,
        ...
        let u;
        return i.rangeStart > 0 || i.rangeEnd < n.length ? u = await $i(n, i) : (!i.requirePragma && i.insertPragma && i.printer.insertPragma && !await nu(n, i) && (n = i.printer.insertPragma(n)),
        u = await iu(n, i)),
        r && (u.formatted = uu + u.formatted,
    ...
    async function su(e, t, r) {
        let {text: n, options: i} = ou(e, await se(t))
          , u = await ce(n, i);
        return r && (r.preprocessForPrint && (u.ast = await Qt(u.ast, i)),
...
`)
    ...
    function no(e, t, r) {
        let n = t === '"' ? "'" : '"'
          , u = ne(!1, e, /\\(.)|(["'])/gsu, (o, s, a) => s === n ? s : a === t ? "\\" + a : a || (r && /^[^\n\r"'0-7\\bfnrt-vx\u2028\u2029]$/u.test(s) ? s : "\\" + s));
        return t + u + t
    }
    var hu = no;
    function uo(e, t, r) {
    ...
    function io(e, t) {
        return arguments.length === 2 || typeof t == "number" ? je(e, t) : uo(...arguments)
    }
    function oo(e, t, r) {
        return Le(e, r(t))
    }
    function so(e, t) {
        return arguments.length === 2 || typeof t == "number" ? Le(e, t) : oo(...arguments)
    }
    function ao(e, t, r) {
        return gt(e, r(t))
    }
    function Do(e, t) {
        return arguments.length === 2 || typeof t == "number" ? gt(e, t) : ao(...arguments)
    }
    function fe(e, t=1) {
        return async (...r) => {
            let n = r[t] ?? {}
