(function(n) {
    ...
    ;
    var Ue = (e, r, t) => (t = e != null ? el(nl(e)) : {},
    Ln(r || !e || !e.__esModule ? xr(t, "default", {
        value: e,
        enumerable: !0
    }) : t, e))
      , ul = e => Ln(xr({}, "__esModule", {
        value: !0
    }), e);
    var wr = C( (Pm, In) => {
        "use strict";
    ...
    var Pi = C( (ov, Oi) => {
        ...
        function vf(e, r) {
            for (var t = r || {}, n = e.prototype, a = n.blockTokenizers, u = n.inlineTokenizers, i = n.blockMethods, o = n.inlineMethods, s = a.definition, l = u.reference, c = [], f = -1, D = i.length, h; ++f < D; )
                h = i[f],
                !(h === "newline" || h === "indentedCode" || h === "paragraph" || h === "footnoteDefinition") && c.push([h]);
            c.push(["footnoteDefinition"]),
            t.inlineNotes && (wt(o, "reference", "inlineNote"),
            u.inlineNote = m),
            ...
            m.locator = B;
            function p(b, g, A) {
                for (var x = this, v = x.interruptFootnoteDefinition, w = x.offset, k = g.length + 1, q = 0, T = [], R, O, S, _, P, ke, j, I, Z, Q, me, Fe, z; q < k && (_ = g.charCodeAt(q),
                !(_ !== lr && _ !== Ye)); )
                    q++;
                        ...
                        Fe = []; q < k; ) {
                            ...
                            _ !== _ || _ === Ur)
                                ...
                                if (_ === Ye || _ === lr)
                                    ...
                                    if (Q < Mr && z && (z.contentStart === z.contentEnd || Cf(v, a, x, [b, g.slice(q, hf), !0])))
                                        break;
                                    Q = void 0,
                                    me = q
                                }
        ...
        function Ef(e) {
            var r = e.prototype.visitors
              , t = "    ";
            r.footnote = n,
            r.footnoteReference = a,
            r.footnoteDefinition = u;
            function n(i) {
...
`)
    ...
    var Mi = C( (cv, zi) => {
        ...
        function kf(e) {
            let r = this.Parser
              , t = this.Compiler;
            Li.isRemarkParser(r) && Bf(r, e),
            Li.isRemarkCompiler(t) && qf(t, e)
        }
        function Bf(e, r) {
            let t = e.prototype
              , n = t.inlineMethods;
            ...
            function u(i, o, s) {
                let l = o.length, c = !1, f = !1, D = 0, h, p, d, m, F, y, E;
                if (o.charCodeAt(D) === Ri && (f = !0,
                D++),
                o.charCodeAt(D) === Yr) {
                    if (D++,
                    f)
                        return s ? !0 : i(o.slice(0, D))({
                            type: "text",
                            value: "$"
                        });
                    if (o.charCodeAt(D) === Yr && (c = !0,
                    D++),
                    d = o.charCodeAt(D),
                    !(d === Ni || d === Ii)) {
                        for (m = D; D < l; ) {
                            ...
                            d = o.charCodeAt(D + 1),
                            p === Yr) {
                                if (h = o.charCodeAt(D - 1),
                                h !== Ni && h !== Ii && (d !== d || d < Af || d > xf) && (!c || d === Yr)) {
                                    F = D - 1,
                                    D++,
                                    c && D++,
                                    y = D;
        ...
        function qf(e) {
            ...
            function t(n) {
                let a = "$";
                return (n.data && n.data.hProperties && n.data.hProperties.className || []).includes(Ui) && (a = "$$"),
                a + n.value + a
            }
        }
    }
...
`
        ...
        function Of() {
            let e = this.Parser
              , r = this.Compiler;
            Yi.isRemarkParser(e) && Pf(e),
            Yi.isRemarkCompiler(r) && Lf(r)
        }
        function Pf(e) {
            let r = e.prototype
              , t = r.blockMethods
            ...
            function i(o, s, l) {
                ...
                for (; f < c && s.charCodeAt(f) === Dr; )
                    f++;
                for (m = f; f < c && s.charCodeAt(f) === qt; )
                    f++;
                if (F = f - m,
                !(F < _f)) {
                    for (; f < c && s.charCodeAt(f) === Dr; )
                    ...
                    if (s.charCodeAt(f) === Gi) {
                        ...
                        p = p === -1 ? c : p; f < c; ) {
                            ...
                            g = p,
                            d = p,
                            B = 0; d > b && s.charCodeAt(d - 1) === Dr; )
                                d--;
                            for (; d > b && s.charCodeAt(d - 1) === qt; )
                                B++,
                                d--;
                            for (F <= B && s.indexOf(Tf, b) === d && (E = !0,
                            g = d); b <= g && b - f < m && s.charCodeAt(b) === Dr; )
                                b++;
                            if (E)
                                for (; g > b && s.charCodeAt(g - 1) === Dr; )
                                    g--;
                            if ((!E || b !== g) && h.push(s.slice(b, g)),
                            E)
                                break;
                            f = p + 1,
                            p = s.indexOf(Vi, f + 1),
...
$$`
    ...
    var Zi = C( (dv, Qi) => {
        ...
        function Yf(e) {
            ...
            for (t in r)
                n = r[t],
                n && typeof n == "object" && (r[t] = "concat"in n ? n.concat() : Mf(n));
            return u;
            function a(i) {
    ...
    var nu = C( (mv, tu) => {
        ...
        function Vf(e) {
            ...
            function u(i) {
                ...
                return !isNaN(o) && !isNaN(s) && o - 1 in t && (l = (t[o - 2] || 0) + s - 1 || 0),
    ...
    var pr = C( (wv, Tu) => {
        ...
        function gD(e, r) {
            ...
            for (a in Eu)
                n = r[a],
                t[a] = n ?? Eu[a];
            return (t.position.indent || t.position.start) && (t.indent = t.position.indent || [],
        ...
        function vD(e, r) {
            ...
            for (typeof t == "string" && (t = t.charCodeAt(0)),
            P = Z(),
            w = i ? Q : oD,
            h--,
            D++; ++h < D; )
                ...
                A = e.charCodeAt(h),
                A === bu) {
                    if (v = e.charCodeAt(h + 1),
                    v === sD || v === Cu || v === cD || v === lD || v === bu || v === DD || v !== v || t && v === t) {
                        F += je(A),
                        d++;
                        continue
                    }
                    ...
                    g = "",
                    _ = Gr[S],
                    I--; ++I < D && (v = e.charCodeAt(I),
                    !!_(v)); )
                        g += je(v),
                        S === $e && aD.call(gu, g) && (E = g,
                        T = gu[g]);
                    b = e.charCodeAt(I) === fD,
                    b && (I++,
                    B = S === $e ? uD(g) : !1,
                    ...
                    T = B)),
                    j = 1 + I - O,
                    !b && !n || (g ? S === $e ? (b && !T ? w(Bu, 1) : (E !== g && (I = R + E.length,
                    j = 1 + I - R,
                    b = !1),
                    b || (k = E ? Au : wu,
                    r.attribute ? (v = e.charCodeAt(I),
                    v === pD ? (w(k, j),
                    T = null) : yu(v) ? T = null : w(k, j)) : w(k, j))),
                    x = T) : (b || w(xu, j),
                    x = parseInt(g, Lt[S]),
                    ED(x) ? (w(qu, j),
                    x = je(FD)) : x in vu ? (w(St, j),
                    x = vu[x]) : (q = "",
                    CD(x) && w(St, j),
                    x > 65535 && (x -= 65536,
                    q += je(x >>> 10 | 55296),
        ...
        function AD(e) {
            ...
            function r(t, n) {
                ...
                F(""); t; ) {
                    ...
                    d = !1; ++f < D && (p = o[f],
                    h = s[p],
                    !(h && (!h.onlyAtStart || a.atStart) && (!h.notInList || !a.inList) && (!h.notInBlock || !a.inBlock) && (!h.notInLink || !a.inLink) && (m = t.length,
                    h.apply(a, [x, t]),
                    d = m !== t.length,
                    d))); )
                        ;
...
`, k + 1);
                ...
                function g() {
                    ...
                    function w(k, q) {
                        ...
                        return k.position.indent = q || [],
                        k
                    }
                }
                function A(v, w) {
                    var k = w ? w.children : i, q = k[k.length - 1], T;
                    return q && v.type === q.type && (v.type === "text" || v.type === "blockquote") && Pu(q) && Pu(v) && (T = v.type === "text" ? xD : wD,
                    v = T.call(a, q, v)),
                    v !== q && k.push(v),
        ...
        function Pu(e) {
            var r, t;
            return e.type !== "text" || !e.position ? !0 : (r = e.position.start,
            t = e.position.end,
        ...
        function wD(e, r) {
            return this.options.commonmark || this.options.gfm ? r : (e.children = e.children.concat(r.children),
            e)
        }
    }
    );
...
`, '"', "$", "%", "&", "'", ",", "/", ":", ";", "<", "=", "?", "@", "^"]);
    ...
    var Zu = C( (Lv, Qu) => {
        ...
        function jr(e, r, t, n) {
            var a, u;
            typeof r == "function" && typeof t != "function" && (n = t,
            t = r,
            r = null),
            u = ID(r),
            a = n ? -1 : 1,
            ...
            function i(o, s, l) {
                ...
                return typeof c.type == "string" && (f = typeof c.tagName == "string" ? c.tagName : typeof c.name == "string" ? c.name : void 0,
                D.displayName = "node (" + ND(c.type + (f ? "<" + f + ">" : "")) + ")"),
                D;
                function D() {
                    var h = l.concat(o), p = [], d, m;
                    if ((!r || u(o, s, l[l.length - 1] || null)) && (p = RD(t(o, l)),
                    p[0] === Ut))
                        return p;
                    if (o.children && p[0] !== Xu)
                        for (m = (n ? o.children.length : -1) + a; m > -1 && m < o.children.length; ) {
                            if (d = i(o.children[m], m, h)(),
                            d[0] === Ut)
                                return d;
...
`
    ...
    var sa = C( (Uv, oa) => {
        ...
        oa.exports = XD;
        function XD(e, r, t) {
            for (var n, a = "", u = 0, i = r.length; u < i && (n = JD.exec(r.slice(u)),
            n != null); )
                u += n[0].length,
                a += n[0];
            if (a !== "") {
...
`
        ...
        function ip(e, r, t) {
            for (var n = -1, a = r.length, u = "", i = "", o = "", s = "", l, c, f; ++n < a; )
                ...
                else if (l === Gt && r.charAt(n + 1) === l && r.charAt(n + 2) === l && r.charAt(n + 3) === l)
                    o += np,
                    n += 3,
                    f = !0;
                else if (l === fa)
    ...
    var Jr = C( (Vv, ga) => {
        ...
        function lp(e, r, t, n) {
            for (var a = e.length, u = -1, i, o; ++u < a; )
                if (i = e[u],
                o = i[1] || {},
                !(o.pedantic !== void 0 && o.pedantic !== t.options.pedantic) && !(o.commonmark !== void 0 && o.commonmark !== t.options.commonmark) && r[i[0]].apply(t, n))
                    return !0;
            return !1
        }
    }
...
`
          ...
          , Ea = ">";
        function pp(e, r, t) {
            for (var n = this, a = n.offset, u = n.blockTokenizers, i = n.interruptBlockquote, o = e.now(), s = o.line, l = r.length, c = [], f = [], D = [], h, p = 0, d, m, F, y, E, B, b, g; p < l && (d = r.charAt(p),
            !(d !== jt && d !== va)); )
                p++;
            if (r.charAt(p) === Ea) {
                if (t)
                    return !0;
                for (p = 0; p < l; ) {
                    for (F = r.indexOf(Vt, p),
                    B = p,
                    b = !1,
                    F === -1 && (F = l); p < l && (d = r.charAt(p),
                    !(d !== jt && d !== va)); )
                        p++;
                    if (r.charAt(p) === Ea ? (p++,
                    b = !0,
...
`
          ...
          , Cp = 3;
        function bp(e, r, t) {
            for (var n = -1, a = r.length + 1, u = "", i, o, s, l; ++n < a && (i = r.charAt(n),
            !(i !== mp && i !== wa)); )
                u += i;
            if (!(i !== gp && i !== vp && i !== Ep))
                for (o = i,
...
`
          ...
          , Vp = /^( {1,4}|\t)?/gm;
        function jp(e, r, t) {
            for (var n = this, a = n.options.commonmark, u = n.options.pedantic, i = n.blockTokenizers, o = n.interruptList, s = 0, l = r.length, c = null, f, D, h, p, d, m, F, y, E, B, b, g, A, x, v, w, k, q, T, R = !1, O, S, _, P; s < l && (p = r.charAt(s),
            !(p !== Xr && p !== de)); )
                s++;
            if (p = r.charAt(s),
            p === Ht || p === La || p === Wt)
            ...
            !(p !== de && p !== Xr && (u || p !== ie && p !== ""))) {
                ...
                w = []; s < l; ) {
                    ...
                    !P) {
                        ...
                        if (E)
                            ...
                            p === Xr)
                                ...
                                for (_ = s + xe; s < _ && r.charAt(s) === de; )
                                    s++,
                                    f++;
                                s === _ && r.charAt(s) === de && (s -= xe - 1,
                                f -= xe - 1)
                            } else
                                p !== ie && p !== "" && (E = null)
                    }
                    if (E) {
                        ...
                        !a && !P && r.charAt(F) === de ? P = !0 : a && k && (P = f >= k.indent || f > xe),
                        y = !1,
                        s = F;
                    if (b = r.slice(F, m),
                    B = F === s ? b : r.slice(s, m),
                    (E === Ht || E === Rp || E === Wt) && i.thematicBreak.call(n, e, b, !0))
                        break;
                    if (g = A,
                    A = !y && !Op(B).length,
                    P && k)
                        k.value = k.value.concat(w, b),
                        v = v.concat(w, b),
                        w = [];
                    else if (y)
                        w.length !== 0 && (R = !0,
        ...
        function Hp(e, r, t) {
            var n = e.offset
              , a = t.line;
            return r = r.replace(Gp, u),
            a = t.line,
            r.replace(Vp, u);
            function u(i) {
                return n[a] = (n[a] || 0) + i.length,
                a++,
                ""
            }
        }
        function Wp(e, r, t) {
            ...
            c = 0,
            f = s.length; ++c < f; )
                n[a] = (n[a] || 0) + s[c].length - l[c].length,
                a++;
            return l.join(ie);
...
`
        ...
        function wd(e, r, t) {
            for (var n = this, a = n.options.blocks.join("|"), u = new RegExp("^</?(" + a + ")(?=(\\s|/?>|$))","i"), i = r.length, o = 0, s, l, c, f, D, h, p, d = [[hd, md, !0], [Fd, gd, !0], [vd, Ed, !0], [Cd, bd, !0], [yd, Ad, !0], [u, Ha, !0], [xd, Ha, !1]]; o < i && (f = r.charAt(o),
            !(f !== Dd && f !== pd)); )
                o++;
            if (r.charAt(o) === dd) {
                for (s = r.indexOf($a, o + 1),
                s = s === -1 ? i : s,
                l = r.slice(o, s),
                c = -1,
                D = d.length; ++c < D; )
...
`
          ...
          , to = ">";
        function Nd(e, r, t) {
            for (var n = this, a = n.options.commonmark, u = 0, i = r.length, o = "", s, l, c, f, D, h, p, d; u < i && (f = r.charAt(u),
            !(f !== Zr && f !== Qr)); )
                o += f,
                u++;
            if (f = r.charAt(u),
            f === en) {
                ...
                if (!(!c || r.charAt(u) !== gr || r.charAt(u + 1) !== eo)) {
                    ...
                    if (c) {
                        ...
                        if (f = r.charAt(u),
                        !f || f === Ke)
                            return t ? !0 : (s = e(s).test().end,
                            p = n.decode.raw(n.unescape(p), s, {
                                nonTerminated: !1
                            }),
                            d && (l = e(l).test().end,
                            d = n.decode.raw(n.unescape(d), l)),
                            e(o)({
                                type: "definition",
                                identifier: Od(h),
                                label: h,
                ...
                !(p.length < jd)) {
                    ...
                    g = e(o).reset({
                        ...
                        m = !0; a < l; ) {
                            ...
                            D === "" || D === rn ? m ? e(D) : ((d || D) && !m && (o = d,
                            f.length > 1 && (D ? (o += f.slice(0, -1),
                            f = f.charAt(f.length - 1)) : (o += f,
                            f = "")),
                            F = e.now(),
                            e(o)({
                                type: "tableCell",
                                children: n.tokenizeInline(d, F)
                            }, s)),
                            e(f + D),
                            f = "",
                            d = "") : (f && (d += f,
...
`
        ...
        function ho(e, r, t) {
            var n = this, a, u;
            if (r.charAt(0) === po && (a = r.charAt(1),
            n.escape.indexOf(a) !== -1))
                return t ? !0 : (a === ih ? u = {
                    type: "break"
                } : u = {
                    type: "text",
    ...
    var yo = C( (sE, bo) => {
        ...
        var Eo = "<"
          ...
          , rt = an.length;
        function on(e, r, t) {
            var n = this, a = "", u = r.length, i = 0, o = "", s = !1, l = "", c, f, D, h, p;
            if (r.charAt(0) === Eo) {
                for (i++,
                a = Eo; i < u && (c = r.charAt(i),
                !(vo(c) || c === nn || c === Co || c === ":" && r.charAt(i + 1) === un)); )
                    o += c,
                    i++;
                if (o) {
                    if (l += o,
                    ...
                    !(!o || c !== nn))
                        ...
                        f.column++,
                        f.offset++,
                        s && (l.slice(0, rt).toLowerCase() === an ? (D = D.slice(rt),
                        f.column += rt,
                        f.offset += rt) : l = an + l),
    ...
    var Oo = C( (fE, So) => {
        ...
        var dh = 33
          ...
          , _o = ")";
        function ln(e, r, t) {
            var n = this, a = n.options.gfm, u = n.inlineTokenizers, i = r.length, o = -1, s = !1, l, c, f, D, h, p, d, m, F, y, E, B, b, g;
            if (a) {
                if (r.slice(0, 4) === "www.")
                    s = !0,
                    D = 4;
                ...
                if (d === cn && (l.pop(),
                D--),
                l[0] !== void 0 && (c = l.length < 2 ? f : l[l.length - 2] + 1,
                r.slice(c, D).indexOf("_") === -1)) {
                    if (t)
                        return !0;
                    for (m = D,
                    h = D; D < i && (d = r.charCodeAt(D),
                    !(Dh(d) || d === yh)); )
                        D++,
                        d === dh || d === Fh || d === gh || d === cn || d === Eh || d === bh || d === To || d === Ah || (m = D);
                    if (D = m,
                    r.charCodeAt(D - 1) === mh)
                        for (p = r.slice(h, D),
                        F = qo(p, xh),
                        y = qo(p, _o); y > F; )
                            D = h + p.lastIndexOf(_o),
                            p = r.slice(h, D),
                            y--;
                    if (r.charCodeAt(D - 1) === Ch && (D--,
                    sn(r.charCodeAt(D - 1)))) {
                        for (m = D - 2; sn(r.charCodeAt(m)); )
                            m--;
                        r.charCodeAt(m) === hh && (D = m)
                    }
                    return E = r.slice(0, D),
                    b = lh(E, {
                        nonTerminated: !1
                    }),
                    s && (b = "http://" + b),
    ...
    var No = C( (DE, Io) => {
        ...
        function Lo(e, r) {
            var t = this, n, a;
            if (!this.options.gfm || (n = e.indexOf("@", r),
            n === -1))
                return -1;
            if (a = n,
            a === r || !Po(e.charCodeAt(a - 1)))
                return Lo.call(t, e, n + 1);
            for (; a > r && Po(e.charCodeAt(a - 1)); )
                a--;
            return a
        }
        function Po(e) {
    ...
    var Mo = C( (pE, zo) => {
        ...
        function pn(e, r, t) {
            ...
            if (a) {
                for (l = r.charCodeAt(i); Ro(l) || Uo(l) || l === Ph || l === fn || l === tt || l === Dn; )
                    l = r.charCodeAt(++i);
                if (i !== 0 && l === Lh) {
                    for (i++; i < o; ) {
                        if (l = r.charCodeAt(i),
                        Ro(l) || Uo(l) || l === fn || l === tt || l === Dn) {
                            i++,
                            s === -1 && l === tt && (s = i);
                            continue
                        }
    ...
    var Vo = C( (dE, Go) => {
        ...
        function Yo(e, r, t) {
            ...
            if (!(r.charAt(0) !== Uh || a < 3) && (u = r.charAt(1),
            !(!Ih(u) && u !== zh && u !== Mh && u !== Yh) && (i = r.match(Rh),
            !!i)))
                return t ? !0 : (i = i[0],
                !n.inLink && Gh.test(i) ? n.inLink = !0 : n.inLink && Vh.test(i) && (n.inLink = !1),
                e(i)({
                    type: "html",
                    value: i
                }))
...
`
            ...
            i === Wo && !(!F && n.inLink)) {
                ...
                if (c) {
                    ...
                    if (r.charAt(u) === Cr)
                        ...
                        b && (p = e(p).test().end,
                        b = n.decode.raw(n.unescape(b), p)),
                        k = {
                            type: F ? "image" : "link",
                            title: b || null,
                            url: x
                        },
                        F ? k.alt = n.decode.raw(n.unescape(y), v) || null : (w = n.enterLink(),
        ...
        function Zo(e, r, t) {
            ...
            u === nt) {
                ...
                u === ut) {
                    ...
                    if (!(f !== gn && y))
                        return s = l + s,
                        c === Fn && n.inLink ? null : t ? !0 : (p = e.now(),
                        p.column += l.length,
                        p.offset += l.length,
                        h = f === gn ? h : D,
                        d = {
                        ...
                        m()) : d.alt = n.decode.raw(n.unescape(D), p) || null,
                        e(s)(d))
                }
            }
        }
    ...
    var os = C( (vE, as) => {
        ...
        function us(e, r, t) {
            ...
            if (!(u !== o0 && u !== s0 || r.charAt(++a) !== u) && (o = n.options.pedantic,
            s = u,
            c = s + s,
            f = r.length,
            a++,
            ...
            !(o && is(r.charAt(a)))))
                for (; a < f; ) {
                    if (D = u,
                    u = r.charAt(a),
                    u === s && r.charAt(a + 1) === s && (!o || !is(D)) && (u = r.charAt(a + 2),
                    u !== s))
                        return i0(l) ? t ? !0 : (i = e.now(),
                        i.column += 2,
                        i.offset += 2,
                        e(c + l + c)({
                            type: "strong",
    ...
    var ms = C( (bE, hs) => {
        ...
        function ds(e, r, t) {
            var n = this, a = 0, u = r.charAt(a), i, o, s, l, c, f, D;
            if (!(u !== m0 && u !== ps) && (o = n.options.pedantic,
            c = u,
            s = u,
            f = r.length,
            a++,
    ...
    var ys = C( (AE, bs) => {
        ...
        function Cs(e, r, t) {
            ...
            if (!(!n.options.gfm || r.charAt(0) !== at || r.charAt(1) !== at || vs(r.charAt(2))))
                for (s = 1,
                l = r.length,
                c = e.now(),
                c.column += 2,
    ...
    var Bs = C( (wE, ks) => {
        ...
        var vn = 10
          ...
          , Cn = 96;
        function ws(e, r, t) {
            for (var n = r.length, a = 0, u, i, o, s, l, c; a < n && r.charCodeAt(a) === Cn; )
                a++;
            if (!(a === 0 || a === n)) {
                for (u = a,
                l = r.charCodeAt(a); a < n; ) {
                    if (s = l,
                    l = r.charCodeAt(a + 1),
                    s === Cn) {
                        if (i === void 0 && (i = a),
...
`
    ...
    var Ls = C( (qE, Ps) => {
        ...
        function k0(e, r, t) {
            ...
            if (t)
                return !0;
            for (a = n.inlineMethods,
            o = a.length,
            u = n.inlineTokenizers,
            i = -1,
            D = r.length; ++i < o; )
                f = a[i],
                !(f === "text" || !u[f]) && (c = u[f].locator,
    ...
    var Gs = C( (_E, Ys) => {
        ...
        function Ms(e) {
            var r = this.data("settings")
              , t = S0(zs);
            t.prototype.options = O0(t.prototype.options, r, e),
            this.Parser = t
        }
    }
    );
    ...
    var rc = C( (PE, ec) => {
        ...
        var st = Object.prototype.hasOwnProperty
          ...
          , Js = function(r) {
            if (!r || Zs.call(r) !== "[object Object]")
                return !1;
            var t = st.call(r, "constructor")
              , n = r.constructor && r.constructor.prototype && st.call(r.constructor.prototype, "isPrototypeOf");
          ...
          , Xs = function(r, t) {
            Hs && t.name === "__proto__" ? Hs(r, t.name, {
                enumerable: !0,
                configurable: !0,
                value: t.newValue,
                writable: !0
        ...
        ec.exports = function e() {
            var r, t, n, a, u, i, o = arguments[0], s = 1, l = arguments.length, c = !1;
            for (typeof o == "boolean" && (c = o,
            o = arguments[1] || {},
            s = 2),
            (o == null || typeof o != "object" && typeof o != "function") && (o = {}); s < l; ++s)
                if (r = arguments[s],
                r != null)
                    for (t in r)
                        n = Qs(o, t),
                        a = Qs(r, t),
                        o !== a && (c && a && (Js(a) || (u = Ks(a))) ? (u ? (u = !1,
                        i = n && Ks(n) ? n : []) : i = n && Js(n) ? n : {},
                        Xs(o, {
                            name: t,
                            newValue: e(c, i, a)
                        })) : typeof a < "u" && Xs(o, {
        ...
        function sc() {
            ...
            function t() {
                ...
                function o(s) {
                    ...
                    for (; ++h < D; )
                        (f[h] === null || f[h] === void 0) && (f[h] = u[h]);
                    u = f,
                    l ? oc(l, o).apply(null, u) : i.apply(null, [null].concat(u))
                }
            }
            function n(a) {
    ...
    var Fc = C( (UE, mc) => {
        ...
        function U0(e) {
            var r = [null, null], t;
            return typeof e == "string" && (t = e.indexOf(":"),
            t === -1 ? r[1] = e : (r[0] = e.slice(0, t),
            r[1] = e.slice(t + 1))),
            r
        }
    }
    ...
    var gc = C(Qe => {
        ...
        function z0(e, r) {
            ...
            if (yr(e),
            a = e.length,
            r === void 0 || !r.length || r.length > e.length) {
                for (; a--; )
            ...
            o = r.length - 1; a--; )
                if (e.charCodeAt(a) === 47) {
                    ...
                    u < 0 && (i = !0,
                    u = a + 1),
                    o > -1 && (e.charCodeAt(a) === r.charCodeAt(o--) ? o < 0 && (n = a) : (o = -1,
                    n = u));
            return t === n ? n = u : n < 0 && (n = e.length),
            e.slice(t, n)
        }
        function M0(e) {
            var r, t, n;
    ...
    var yc = C( (YE, bc) => {
        ...
        Object.defineProperty(he.prototype, "path", {
            get: J0,
            set: X0
        });
        ...
        Object.defineProperty(he.prototype, "stem", {
            get: im,
            set: um
        });
        function he(e) {
            ...
            t = -1; ++t < wn.length; )
                r = wn[t],
                K0.call(e, r) && (this[r] = e[r]);
            for (r in e)
                wn.indexOf(r) < 0 && (this[r] = e[r])
        }
        function J0() {
        ...
        function Z0(e) {
            Cc(this.path, "dirname"),
            this.path = ae.join(e || "", this.basename)
        }
        function em() {
        ...
        function kn(e, r) {
            if (e && e.indexOf(ae.sep) > -1)
                throw new Error("`" + r + "` cannot be a path: did not expect `" + ae.sep + "`")
        }
        function Bn(e, r) {
            if (!e)
    ...
    var xc = C( (GE, Ac) => {
        ...
        function sm(e, r, t) {
            var n = new om(e,r,t);
            return this.path && (n.name = this.path + ":" + n.name,
            n.file = this.path),
            n.fatal = !1,
    ...
    var Ic = C( (jE, Lc) => {
        ...
        function Fm(e, r) {
            ...
            t == null || (typeof t == "string" || fm(t) ? ("value"in r.file && (r.file.value = t),
            r.file.contents = t) : r.file.result = t)
        }
        function Pc() {
            var e = [], r = Oc(), t = {}, n = -1, a;
            return u.data = o,
            ...
            u;
            function u() {
                for (var m = Pc(), F = -1; ++F < e.length; )
                    m.use.apply(null, e[F]);
                return m.data(lt(!0, {}, t)),
                m
            }
            function i() {
                var m, F;
            ...
            function o(m, F) {
                return typeof m == "string" ? arguments.length === 2 ? (_n("data", a),
                t[m] = F,
                u) : pm.call(t, m) && t[m] || null : m ? (_n("data", a),
                t = m,
                u) : t
            }
            function s(m) {
                ...
                return F && (t.settings = lt(t.settings || {}, F)),
                u;
                function y(g) {
                    B(g.plugins),
                    g.settings && (F = lt(F || {}, g.settings))
                }
                function E(g) {
                ...
                function b(g, A) {
                    var x = l(g);
                    x ? (qc(x[1]) && qc(A) && (A = lt(!0, x[1], A)),
                    x[1] = A) : e.push(Dm.call(arguments))
                }
            }
            function l(m) {
    ...
    var $ = "string"
      ...
      , fe = "label"
      , te = "break-parent"
      , kr = new Set([ge, ee, re, oe, K, J, X, se, ce, le, W, fe, te]);
    function cl(e) {
        if (typeof e == "string")
            return $;
        if (Array.isArray(e))
    ...
    var Y = cl;
    var ll = e => new Intl.ListFormat("en-US",{
        type: "disjunction"
    }).format(e);
    function fl(e) {
...
...`, t)),
    ...
    function dt(e) {
        let r = `@(${Wn.join("|")})`
          , t = new RegExp([`<!--\\s*${r}\\s*-->`, `\\{\\s*\\/\\*\\s*${r}\\s*\\*\\/\\s*\\}`, `<!--.*\r?
[\\s\\S]*(^|
)[^\\S
]*${r}[^\\S
]*($|
...
${r.content}`
    ...
    function Qn(e, r, t) {
        if ((e.type === "front-matter" || e.type === "code" || e.type === "yaml" || e.type === "import" || e.type === "export" || e.type === "jsx") && delete r.value,
        e.type === "list" && delete r.isAligned,
        (e.type === "list" || e.type === "listItem") && delete r.spread,
        e.type === "text")
            return null;
        if (e.type === "inlineCode" && (r.value = N(!1, e.value, `
`, " ")),
        e.type === "wikiLink" && (r.value = N(!1, e.value.trim(), /[\t\n]+/gu, " ")),
        (e.type === "definition" || e.type === "linkReference" || e.type === "imageReference") && (r.label = (0,
        Xn.default)(e.label)),
        (e.type === "link" || e.type === "image") && e.url && e.url.includes("("))
            for (let n of "<>")
                r.url = N(!1, e.url, n, encodeURIComponent(n));
        if ((e.type === "definition" || e.type === "link" || e.type === "image") && e.title && (r.title = N(!1, e.title, /\\(?=["')])/gu, "")),
        (t == null ? void 0 : t.type) === "root" && t.children.length > 0 && (t.children[0] === e || Hn(t.children[0]) && t.children[1] === e) && e.type === "html" && dt(e.value))
            return null
    }
    Qn.ignoredProperties = Cl;
    var Zn = Qn;
    var ei = /(?:[\u02ea-\u02eb\u1100-\u11ff\u2e80-\u2e99\u2e9b-\u2ef3\u2f00-\u2fd5\u2ff0-\u303f\u3041-\u3096\u3099-\u309f\u30a1-\u30fa\u30fc-\u30ff\u3105-\u312f\u3131-\u318e\u3190-\u4dbf\u4e00-\u9fff\ua700-\ua707\ua960-\ua97c\uac00-\ud7a3\ud7b0-\ud7c6\ud7cb-\ud7fb\uf900-\ufa6d\ufa70-\ufad9\ufe10-\ufe1f\ufe30-\ufe6f\uff00-\uffef]|[\ud840-\ud868\ud86a-\ud86c\ud86f-\ud872\ud874-\ud879\ud880-\ud883\ud885-\ud887][\udc00-\udfff]|\ud81b[\udfe3]|\ud82b[\udff0-\udff3\udff5-\udffb\udffd-\udffe]|\ud82c[\udc00-\udd22\udd32\udd50-\udd52\udd55\udd64-\udd67]|\ud83c[\ude00\ude50-\ude51]|\ud869[\udc00-\udedf\udf00-\udfff]|\ud86d[\udc00-\udf39\udf40-\udfff]|\ud86e[\udc00-\udc1d\udc20-\udfff]|\ud873[\udc00-\udea1\udeb0-\udfff]|\ud87a[\udc00-\udfe0]|\ud87e[\udc00-\ude1d]|\ud884[\udc00-\udf4a\udf50-\udfff]|\ud888[\udc00-\udfaf])(?:[\ufe00-\ufe0f]|\udb40[\udd00-\uddef])?/u
      , Se = /(?:[\u0021-\u002f\u003a-\u0040\u005b-\u0060\u007b-\u007e]|\p{General_Category=Connector_Punctuation}|\p{General_Category=Dash_Punctuation}|\p{General_Category=Close_Punctuation}|\p{General_Category=Final_Punctuation}|\p{General_Category=Initial_Punctuation}|\p{General_Category=Other_Punctuation}|\p{General_Category=Open_Punctuation})/u;
    ...
    function xl(e, r) {
        let t = e.plugins.flatMap(a => a.languages ?? [])
          , n = Al(t, r.language) ?? ti(t, r.physicalFile) ?? ti(t, r.file) ?? (r.physicalFile,
        void 0);
    ...
    var ht = new Set(["liquidNode", "inlineCode", "emphasis", "esComment", "strong", "delete", "wikiLink", "link", "linkReference", "image", "imageReference", "footnote", "footnoteReference", "sentence", "whitespace", "word", "break", "inlineMath"])
      , Pr = new Set([...ht, "tableCell", "paragraph", "heading"])
      , Le = "non-cjk"
      , De = "cj-letter"
      , be = "k-letter"
      , ur = "cjk-punctuation"
...
` : " "
        ...
        function n(a) {
            let u = M(!1, r, -1);
            (u == null ? void 0 : u.type) === "word" && !i(Le, ur) && ![u.value, a.value].some(o => /\u3000/u.test(o)) && r.push({
                type: "whitespace",
                value: ""
            }),
            r.push(a);
    ...
    function Me(e, r) {
        let t = r.originalText.slice(e.position.start.offset, e.position.end.offset)
          , {numberText: n, leadingSpaces: a} = t.match(/^\s*(?<numberText>\d+)(\.|\))(?<leadingSpaces>\s*)/u).groups;
        return {
            number: Number(n),
            leadingSpaces: a
        }
    ...
    function ii(e, r) {
        return !e.ordered || e.children.length < 2 || Me(e.children[1], r).number !== 1 ? !1 : Me(e.children[0], r).number !== 0 ? !0 : e.children.length > 2 && Me(e.children[2], r).number === 1
    }
    function Ir(e, r) {
        let {value: t} = e;
...
`) ? t.slice(0, -1) : t
    ...
    function ye(e, r) {
        return function t(n, a, u) {
            ...
            return i.children && (i.children = i.children.map( (o, s) => t(o, s, [i, ...u]))),
            i
        }(e, null, [])
    }
    function mt(e) {
    ...
    function or(e) {
        if (ar !== null && typeof ar.property) {
            let r = ar;
            return ar = or.prototype = null,
            r
        }
        return ar = or.prototype = e ?? Object.create(null),
        new or
    }
    var ql = 10;
    for (let e = 0; e <= ql; e++)
...
`
    ...
    function Il(e, r, t) {
        return r === Number.NEGATIVE_INFINITY ? e.root || di() : r < 0 ? gt(e, {
            type: "dedent"
        }, t) : r ? r.type === "root" ? {
            ...e,
            root: e
            ...
            case K:
                {
                    if (u && c.break)
                        return !1;
                    let D = c.break ? G : l
                      , h = c.expandedStates && D === G ? M(!1, c.expandedStates, -1) : c.contents;
                    o.push({
                        mode: D,
                        doc: h
                    });
...
`, a) : p;
            ...
            case J:
                {
                    ...
                    Nr({
                        ...
                        mode: ne,
                        doc: [F, y, v]
                    }, [], d, l.length > 0, t, !0) ? i.push(x, g, E) : b ? i.push(x, A, E) : i.push(x, A, B);
                    break
                }
            case X:
            case se:
            ...
            case W:
                ...
                case G:
                    ...
                    p.literal ? D.root ? (o.push(a, D.root.value),
                    u = D.root.length) : (o.push(a),
                    u = 0) : (u -= vt(o),
                    o.push(a + D.value),
                    u = D.length);
                    break
            ...
            i.length === 0 && l.length > 0 && (i.push(...l.reverse()),
            l.length = 0)
        }
        let f = o.indexOf(cr);
        if (f !== -1) {
    ...
    function mi(e, r, t) {
        let {node: n} = e
          , a = []
          , u = e.map( () => e.map( ({index: f}) => {
            let D = hi(t(), r).formatted
              , h = sr(D);
            return a[f] = Math.max(a[f] ?? 3, h),
            {
                text: D,
                width: h
            }
    ...
    function zl(e, r) {
        return ye(e, t => t.type !== "text" || t.value === "*" || t.value === "_" || !Rl.test(t.value) || t.position.end.offset - t.position.start.offset === t.value.length ? t : {
            ...t,
            value: r.originalText.slice(t.position.start.offset, t.position.end.offset)
        })
    }
    function Ml(e, r, t) {
        return ye(e, n => {
            ...
            let a = n.children.reduce( (u, i) => {
                let o = M(!1, u, -1);
                return o && r(o, i) ? u.splice(-1, 1, t(o, i)) : u.push(i),
                u
            }
            , []);
            return {
    ...
    function Yl(e) {
        return Ml(e, (r, t) => r.type === "text" && t.type === "text", (r, t) => ({
            type: "text",
    ...
    function Gl(e) {
        return ye(e, (r, t, [n]) => {
            if (r.type !== "text")
                return r;
            let {value: a} = r;
            return n.type === "paragraph" && (t === 0 && (a = a.trimStart()),
    ...
    function jl(e, r) {
        ...
        function n(a) {
            if (!a.ordered)
                return !0;
            let[u,i] = a.children;
            if (Me(u, r).leadingSpaces.length > 1)
                return !0;
            let s = t(u);
            if (s === -1)
                return !1;
            ...
            let l = t(i);
            return s !== l ? !1 : s % r.tabWidth === 0 ? !0 : Me(i, r).leadingSpaces.length > 1
        }
    }
    var gi = Ul;
    function vi(e, r) {
    ...
    var $l = new Set(["heading", "tableCell", "link", "wikiLink"])
      , Hl = new Set(`$(\xA3\xA5\xB7'"\u3008\u300A\u300C\u300E\u3010\u3014\u3016\u301D\uFE59\uFE5B\uFF04\uFF08\uFF3B\uFF5B\uFFE1\uFFE5[{\u2035\uFE34\uFE35\uFE37\uFE39\uFE3B\uFE3D\uFE3F\uFE41\uFE43\uFE4F\u3018\uFF5F\xAB`)
      , Wl = new Set(`!%),.:;?]}\xA2\xB0\xB7'"\u2020\u2021\u203A\u2103\u2236\u3001\u3002\u3003\u3006\u3015\u3017\u301E\uFE5A\uFE5C\uFF01\uFF02\uFF05\uFF07\uFF09\uFF0C\uFF0E\uFF1A\uFF1B\uFF1F\uFF3D\uFF5D\uFF5E\u2013\u2014\u2022\u3009\u300B\u300D\uFE30\uFE31\uFE32\uFE33\uFE50\uFE51\uFE52\uFE53\uFE54\uFE55\uFE56\uFE58\uFE36\uFE38\uFE3A\uFE3C\uFE3E\uFE40\uFE42\uFE57\uFF5C\uFF64\u300F\u3011\u3019\u301F\uFF60\xBB\u30FD\u30FE\u30FC\u30A1\u30A3\u30A5\u30A7\u30A9\u30C3\u30E3\u30E5\u30E7\u30EE\u30F5\u30F6\u3041\u3043\u3045\u3047\u3049\u3063\u3083\u3085\u3087\u308E\u3095\u3096\u31F0\u31F1\u31F2\u31F3\u31F4\u31F5\u31F6\u31F7\u31F8\u31F9\u31FA\u31FB\u31FC\u31FD\u31FE\u31FF\u3005\u303B\u2010\u30A0\u301C\uFF5E\u203C\u2047\u2048\u2049\u30FB\u3099\u309A`)
      , Ei = new Set("!\"#$%&'()*+,-./:;<=>?@[\\]^_`{|}~");
    ...
    function Jl(e, r) {
        ...
        let a = t.kind
          , u = n.kind;
        return bi(a) && bi(u) || a === be && u === De || u === be && a === De ? !0 : a === ur || u === ur || a === De && u === De ? !1 : Ei.has(n.value[0]) || Ei.has(M(!1, t.value, -1)) ? !0 : t.hasTrailingPunctuation || n.hasLeadingPunctuation ? !1 : Kl(e)
    }
    function Ci(e) {
    ...
    function Xl(e, r, t, n, a) {
        if (t !== "always" || e.hasAncestor(s => $l.has(s.type)))
            return !1;
        if (n)
            return r !== "";
        if (r === " ")
        ...
        return !(r === "" && ((u == null ? void 0 : u.kind) === be && Ci(i == null ? void 0 : i.kind) || (i == null ? void 0 : i.kind) === be && Ci(u == null ? void 0 : u.kind)) || !a && (i && Wl.has(i.value[0]) || u && Hl.has(M(!1, u.value, -1))))
    }
    function Et(e, r, t, n) {
        if (t === "preserve" && r === `
`)
...
` && Jl(e, n);
    ...
    function Zl(e, r, t) {
        ...
        if (af(e)) {
            let i = [""]
              , o = Lr(r.originalText.slice(n.position.start.offset, n.position.end.offset));
            for (let s of o) {
                if (s.type === "word") {
        ...
        case "word":
            {
                let i = N(!1, N(!1, n.value, "*", String.raw`\*`), new RegExp([`(^|${Se.source})(_+)`, `(_+)(${Se.source}|$)`].join("|"),"gu"), (l, c, f, D, h) => N(!1, f ? `${c}${f}` : `${D}${h}`, "_", String.raw`\_`))
                  , o = (l, c, f) => l.type === "sentence" && f === 0
                  , s = (l, c, f) => mt(l.children[f - 1]);
                return i !== n.value && (e.match(void 0, o, s) || e.match(void 0, o, (l, c, f) => l.type === "emphasis" && f === 0, s)) && (i = i.replace(/^(\\?[*_])+/u, l => N(!1, l, "\\", ""))),
                i
            }
        case "whitespace":
            {
        ...
        case "emphasis":
            {
                ...
                if (mt(n.children[0]))
                    ...
                    i = (o == null ? void 0 : o.type) === "sentence" && ((a = M(!1, o.children, -1)) == null ? void 0 : a.type) === "word" && !M(!1, o.children, -1).hasTrailingPunctuation || (s == null ? void 0 : s.type) === "sentence" && ((u = s.children[0]) == null ? void 0 : u.type) === "word" && !s.children[0].hasLeadingPunctuation || e.hasAncestor(c => c.type === "emphasis") ? "*" : "_"
                }
                return [i, V(e, r, t), i]
            }
        case "strong":
        ...
        case "inlineCode":
            {
                let i = r.proseWrap === "preserve" ? n.value : N(!1, n.value, `
`, " ")
                  , o = Gn(i, "`")
                  , s = "`".repeat(o || 1)
                  , l = i.startsWith("`") || i.endsWith("`") || /^[\n ]/u.test(i) && /[\n ]$/u.test(i) && /[^\n ]/u.test(i) ? " " : "";
                return [s, l, i, l, s]
            }
        case "wikiLink":
            {
                let i = "";
                return r.proseWrap === "preserve" ? i = n.value : i = N(!1, n.value, /[\t\n]+/gu, " "),
                ["[[", i, "]]"]
            }
        case "link":
        ...
        case "definition":
            {
                ...
                return ze([bt(n), ":", Ze([i, Ct(n.url), n.title === null ? "" : [i, Rr(n.title, r, !1)]])])
            }
        case "footnote":
            return ["[^", V(e, r, t), "]"];
        ...
        case "footnoteDefinition":
            {
                ...
                return [Bi(n), ": ", i ? V(e, r, t) : ze([ve(" ".repeat(4), V(e, r, t, {
                    processor: ({isFirst: o}) => o ? ze([Tr, t()]) : t()
                }))])]
            }
        case "table":
            return mi(e, r, t);
        ...
        return V(e, r, t, {
            processor({index: i}) {
                if (n.length > 0) {
                    let o = n[0];
                    if (i === o.start.index)
                        return [xi(u[o.start.index]), r.originalText.slice(o.start.offset, o.end.offset), xi(u[o.end.index])];
    ...
    function V(e, r, t, n={}) {
        ...
        return e.each( () => {
            let i = a(e);
            i !== !1 && (u.length > 0 && nf(e) && (u.push(L),
            (uf(e, r) || ki(e)) && u.push(L),
            ki(e) && u.push(L)),
            u.push(i))
        }
        , "children"),
    ...
    function yt(e) {
        ...
        if (e.type === "html")
            ...
            let t;
            e.type === "esComment" ? t = e : e.type === "paragraph" && e.children.length === 1 && e.children[0].type === "esComment" && (t = e.children[0]),
...
`)
    ...
    function uf({node: e, previous: r, parent: t}, n) {
        ...
        let i = r.type === e.type && Ql.has(e.type)
          ...
          , c = e.type === "html" && t.type === "listItem" && r.type === "paragraph" && r.position.end.line + 1 === e.position.start.line;
        return !(i || o || s || l || c)
    }
    ...
    var of = (e, r) => {
        for (let t of r)
            e = N(!1, e, t, encodeURIComponent(t));
        return e
    }
    ;
    function Ct(e, r=[]) {
    ...
    var ff = {
        proseWrap: At.proseWrap,
        singleQuote: At.singleQuote
    }
      , Si = ff;
    var On = {};
    Pn(On, {
...
`
    ...
    var ym = function() {
      ...
      , Gc = ym;
    function Am() {
        return e => ye(e, (r, t, [n]) => r.type !== "html" || Rc.test(r.value) || Pr.has(n.type) ? r : {
            ...r,
            type: "jsx"
        })
    }
    ...
    var xm = function() {
        let e = this.Parser.prototype
          , r = e.inlineMethods;
        r.splice(r.indexOf("text"), 0, "liquid"),
        e.inlineTokenizers.liquid = t;
        function t(n, a) {
            let u = a.match(/^(\{%.*?%\}|\{\{.*?\}\})/su);
            if (u)
                return n(u[0])({
    ...
    function Qc({isMDX: e}) {
        return r => {
            let t = (0,
            Xc.default)().use(Jc.default, {
                commonmark: !0,
                ...e && {
                    blocks: [Nc]
                }
            }).use(Wc.default).use(Gc).use(Kc.default).use(e ? Yc : Hc).use(jc).use(e ? Vc : Hc).use($c);
